module.exports = {
  ...
  <div>
    <div style="padding-top: 8px; width: 70%">
      ...
      <select id="info" class="round">
        ...
        <option value="15">User Banner URL</option>
      </select>
    </div>
  </div>
  <br>
  ...
  async action(cache) {
    ...
    // Fetch the user's banner before accessing the URL
    await user.fetch(); // Add this line to fetch additional user data, including the banner
